            ...
            DruidQueryCtrl = (function (_super) {
                ...
                function DruidQueryCtrl($scope, $injector, $q) {
                    ...
                    _this.aggregatorValidators = {
                        ...
                        "doubleAny": lodash_1.default.partial(_this.validateSimpleAggregator.bind(_this), 'doubleAny'),
                        "doubleFirst": lodash_1.default.partial(_this.validateSimpleAggregator.bind(_this), 'doubleFirst'),
                        "doubleLast": lodash_1.default.partial(_this.validateSimpleAggregator.bind(_this), 'doubleLast'),
                        "doubleMax": lodash_1.default.partial(_this.validateSimpleAggregator.bind(_this), 'doubleMax'),
                        "doubleMean": lodash_1.default.partial(_this.validateSimpleAggregator.bind(_this), 'doubleMin'),
                        ...
                        "floatAny": lodash_1.default.partial(_this.validateSimpleAggregator.bind(_this), 'floatAny'),
                        "floatFirst": lodash_1.default.partial(_this.validateSimpleAggregator.bind(_this), 'floatFirst'),
                        "floatLast": lodash_1.default.partial(_this.validateSimpleAggregator.bind(_this), 'floatLast'),
                        ...
                        "longAny": lodash_1.default.partial(_this.validateSimpleAggregator.bind(_this), 'longAny'),
                        "longFirst": lodash_1.default.partial(_this.validateSimpleAggregator.bind(_this), 'longFirst'),
                        "longLast": lodash_1.default.partial(_this.validateSimpleAggregator.bind(_this), 'longLast'),
                        ...
                        "stringAny": lodash_1.default.partial(_this.validateSimpleAggregator.bind(_this), 'stringAny'),
